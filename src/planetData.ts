...
const mercuryStaticData: Orbital_Data = {
    date: (2451545 * (24 * 60 * 60 * 1000)) - t, //J2000 = Number of milliseconds since January 1, 4713 BC ending on Jan 1 2000 at 12:00pm
    M: 252.25084,
    e: 0.20563069,
    a: 0.38709893,
    o: 48.33167 * degToRad,
  ...
  const venusStaticData: Orbital_Data = {
    date: (2451545 * (24 * 60 * 60 * 1000)) - t, //j2000 in milliseconds
    M: 181.97973,
    e: 0.00677323,
    a: 0.72333199,
    o: 76.68069 * degToRad,
